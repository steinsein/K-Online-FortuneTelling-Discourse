# -*- coding: utf-8 -*-
"""감성 점수 변환 및 3색 분포 시각화 (50k 데이터용)

입력: 50ksentiment/sentiment_50k.csv
출력: 50ksentiment/ (변환 CSV + 3개 그래프)
"""
...
INPUT_FILE = BASE / '50ksentiment' / 'sentiment_50k.csv'
OUTPUT_DIR = BASE / 'sentiment_result_new'


def main():
    print(f"{'='*70}")
    print("감성 점수 변환 및 3색 분포 시각화 (50k)")
    print(f"{'='*70}\n")
    ...
    # 5. 변환된 데이터 저장
    output_csv = OUTPUT_DIR / '50k_sentiment_transformed.csv'
    ...
    plt.tight_layout()
    hist_path = OUTPUT_DIR / '50k_sentiment_3color_histogram.png'
    ...
    plt.tight_layout()
    kde_path = OUTPUT_DIR / '50k_sentiment_3color_density.png'
    ...
    plt.tight_layout()
    pie_path = OUTPUT_DIR / '50k_sentiment_3color_pie.png'
